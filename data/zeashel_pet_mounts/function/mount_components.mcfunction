...
execute as @e[type=acacia_boat,tag=zeashel_pet_mounts.placeholder_h8dABkQm,limit=1,sort=nearest] at @s unless entity @e[type=minecraft:cat,distance=..10] run ride @e[type=minecraft:wolf,limit=1,distance=..10,sort=nearest] mount @s
