...
execute as @e[type=acacia_boat,tag=placeholder_zeashel_prh8dABkQm,limit=1,sort=nearest] at @s run ride @e[type=minecraft:cat,limit=1,distance=..10,sort=nearest] mount @s
