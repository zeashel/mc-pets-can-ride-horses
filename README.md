# Pets Can Ride Horses

A 26.x minecraft datapack that allows nearest cat or wolf within a 5 block radius to ride horses with you (as pictured below). [How to install](#installation).
...
- Optional: I highly recommend using this mod with:
    ...
    - This is not required and the mod will still function fine in vanilla minecraft, but it highly improves the animations of your pets sitting on the horse and removes the invisible water visual glitch!
- Compatible with my [Immortal Pets datapack](https://github.com/zeashel/mc-immortal-pets).

## Installation

1. Download the .zip file from this [github's releases](https://github.com/zeashel/mc-pets-can-ride-horses/releases) or the modrinth page.
2. Unzip the file.
...
- Without Optifine/EMF installed, there will be a slight visual glitch of an invisible water patch when riding a horse (as pictured below).
...
This mod has been thoroughly tested in singleplayer but should work on multiplayer as well, and no issues have been found other than the ones mentioned above. If you experience any unreported issues, please report it as a [github issue here](https://github.com/zeashel/mc-pets-can-ride-horses/issues).
